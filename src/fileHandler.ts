...
class fileHandler{
    ...
    async update() {
		...
		let body: Buffer = await this.downloadFile();
		const parsedJSON = JSON.parse(body.toString());

		parsedJSON.updated_date = new Date();
		const json = JSON.stringify(parsedJSON);
		// fs.writeFileSync('vatsimData.json', json, function(err: string, result: string): void {
		// 	if(err) console.log(err);
        // });
...
var compareJson = function() {
	return {
		...
		isFunction: function (x: Object) {
		  return Object.prototype.toString.call(x) === '[object Function]';
		},
		isArray: function (x: Object) {
		  return Object.prototype.toString.call(x) === '[object Array]';
		},
		isDate: function (x: Object) {
		  return Object.prototype.toString.call(x) === '[object Date]';
		},
		isObject: function (x: Object) {
		  return Object.prototype.toString.call(x) === '[object Object]';
		},
		isValue: function (x: Object) {
